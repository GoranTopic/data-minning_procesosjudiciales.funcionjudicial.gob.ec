...
import type { AutoscaledPoolOptions, CrawlingContext, EnqueueLinksOptions, EventManager, FinalStatistics, GetUserDataFromRequest, ProxyInfo, Request, RequestList, RequestOptions, RequestQueueOperationOptions, RouterHandler, RouterRoutes, Session, SessionPoolOptions } from '@crawlee/core';
