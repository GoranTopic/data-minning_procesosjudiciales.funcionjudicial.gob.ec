...
class BasicCrawler {
    ...
    constructor(options = {}, config = core_1.Configuration.getGlobalConfig()) {
        ...
        handleRequestFunction, requestHandler, handleRequestTimeoutSecs, requestHandlerTimeoutSecs, errorHandler, handleFailedRequestFunction, failedRequestHandler, statusMessageLoggingInterval = 10, } = options;
    ...
    async run(requests, options) {
        ...
        if (this.running === false && this.requestQueue?.name === 'default' && purgeRequestQueue) {
            ...
            this.requestQueue = await core_1.RequestQueue.open();
        }
        this.running = true;
        this.stats.reset();
