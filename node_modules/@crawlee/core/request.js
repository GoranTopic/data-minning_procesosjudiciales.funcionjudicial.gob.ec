...
class Request {
    ...
    constructor(options) {
        ...
        const { id, url, loadedUrl, uniqueKey, payload, noRetry = false, retryCount = 0, maxRetries, errorMessages = [], headers = {}, userData = {}, label, handledAt, keepUrlFragment = false, useExtendedUniqueKey = false, skipNavigation, } = options;
