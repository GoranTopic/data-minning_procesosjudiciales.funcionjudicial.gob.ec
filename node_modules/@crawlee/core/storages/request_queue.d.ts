...
export declare class RequestQueue {
     ...
     */
    protected _addFetchedRequests(source: InternalSource, fetchedRequests: RequestOptions[], options: RequestQueueOperationOptions): Promise<import("@crawlee/types").ProcessedRequest[]>;
    /**
